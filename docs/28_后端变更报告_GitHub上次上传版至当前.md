...
| TC-04 孤立设备 | **62/57/5** | R005_2 检出；R005_1 双口径后由 3 条减至 1 条（真实孤立保留） |
...
| TC-10 字段为空 | **65/57/8** | R005_2×2/R005_3×2 检出；R005_1×2 双口径后保留（编码缺失真实问题） |
| TC-01 2.6/2.8 基线 | **57/57/0** | 2026-08-22 R005_1 双口径后全绿（原 60/57/3 = R005_1×2 + R021） |
...
4. TC-01 2.6/2.8 在 R005_1 双口径后为 **57/57/0 全绿**（2026-08-22 优化：同码或 REF_PM 等价，依据官方 6.4/6.5）；赛题一/四 287/57/230 不变。
